...
export default function CbtResultsPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto py-8">
      <h2 className="text-2xl font-bold mb-6">CBT 전체 풀이 결과</h2>
      <ul className="space-y-3">
        {results.map(result => (
          <li key={result.id}>
            <Link href={`/mypage/cbt-result/${result.id}`} className="block p-4 bg-neutral-700/50 rounded-lg hover:bg-neutral-700 transition-colors">
